...
class PGMapEditor : public Scene {
	protected:
	private:
	...
	public:
		...
		void PGMapEditor::Update(Controler *controler, double timeElapse) override {
			Scene::Update(controler, timeElapse);
		}
		void PGMapEditor::Render(BaseRenderer *renderer) override {
		...
		void PGMapEditor::Build(MousePicker* mouse_picker) {
...
*/
		...
		void PGMapEditor::HandleControler(Controler *controler) override {
