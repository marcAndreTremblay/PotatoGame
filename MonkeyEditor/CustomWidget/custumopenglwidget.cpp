...
void CustumOpenGlWidget::initializeGL()
{
    ...
    if(result == true){
        this->glClearColor(1.f, 1.f, 1.0f, 1.f);

    }else{
       this->glClearColor(0.1f, 1.0f, 1.0f, 1.f);
    }
                    ...
                    line_mesh->BuildVAO(200);
                    line_mesh->Add(QVector4D(100.f,0.0f,0.0f,1.0f),QVector4D(-100.f,0.0f,0.0f,1.0f),QVector4D(1.f,0.0f,0.0f,1.0f));
