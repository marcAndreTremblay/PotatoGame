...
PShaderProgram::PShaderProgram(const char * vertex_src, const char * fragment_src)
{
...
PShaderProgram::PShaderProgram(const char * vertex_src, const char * fragment_src, const char * geometry_src)
{
    this->initializeOpenGLFunctions();
    GLint Result = GL_FALSE;
    int InfoLogLength;
...
void PShaderProgram::Use() {
    glUseProgram(this->ShaderID);
}
GLuint PShaderProgram::CompileShaderScr(GLuint shaderId, const char * shader_scr) {
    GLint Result = GL_FALSE;
    int InfoLogLength;
